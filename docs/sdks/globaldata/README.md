...
with SDK(
    ...
    res = sdk.global_data.get_certificates(certificate_ids=[], organization_id="<id>")
...
with SDK(
    ...
    res = sdk.global_data.get_host_timeline(host_id="<id>", start_time=parse_datetime("2024-10-02T01:32:37.490Z"), end_time=parse_datetime("2025-02-08T13:31:28.844Z"), organization_id="<id>")
