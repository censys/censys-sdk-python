...
* [get_web_property_timeline](#get_web_property_timeline) - Get web property event history
...
<!-- UsageSnippet language="python" operationID="v3-globaldata-asset-webproperty-timeline" method="get" path="/v3/global/asset/webproperty/{webproperty_id}/timeline" -->
```python
from censys_platform import SDK
from censys_platform.utils import parse_datetime
...
with SDK(
    ...
    res = sdk.global_data.get_web_property_timeline(webproperty_id="platform.censys.io:80", start_time=parse_datetime("2025-01-02T00:00:00Z"), end_time=parse_datetime("2025-01-01T00:00:00Z"))
...
**[models.V3GlobaldataAssetWebpropertyTimelineResponse](../../models/v3globaldataassetwebpropertytimelineresponse.md)**
