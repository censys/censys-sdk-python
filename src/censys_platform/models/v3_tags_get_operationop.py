...
class V3TagsGetOperationGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3TagsGetOperationGlobals(BaseModel):
...
class V3TagsGetOperationRequestTypedDict(TypedDict):
    tag_id: str
    r"""The ID of the tag the operation belongs to."""
    operation_id: str
    r"""The ID of the operation to retrieve."""
    organization_id: NotRequired[str]
...
class V3TagsGetOperationRequest(BaseModel):
    tag_id: Annotated[
...
class V3TagsGetOperationResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ResponseEnvelopeTagOperationTypedDict


class V3TagsGetOperationResponse(BaseModel):
    headers: Dict[str, List[str]]
