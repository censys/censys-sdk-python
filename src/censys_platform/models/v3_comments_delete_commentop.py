...
class V3CommentsDeleteCommentGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3CommentsDeleteCommentGlobals(BaseModel):
...
class V3CommentsDeleteCommentRequestTypedDict(TypedDict):
    comment_id: str
    r"""The ID of the comment to delete."""
    organization_id: NotRequired[str]
...
class V3CommentsDeleteCommentRequest(BaseModel):
...
class V3CommentsDeleteCommentResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]


class V3CommentsDeleteCommentResponse(BaseModel):
    headers: Dict[str, List[str]]
