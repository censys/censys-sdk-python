...
class V3CommentsCreateCommentGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3CommentsCreateCommentGlobals(BaseModel):
...
class V3CommentsCreateCommentRequestTypedDict(TypedDict):
    create_comment_input_body: CreateCommentInputBodyTypedDict
    organization_id: NotRequired[str]
...
class V3CommentsCreateCommentRequest(BaseModel):
    create_comment_input_body: Annotated[
        CreateCommentInputBody,
...
class V3CommentsCreateCommentResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ResponseEnvelopeCommentTypedDict


class V3CommentsCreateCommentResponse(BaseModel):
    headers: Dict[str, List[str]]
