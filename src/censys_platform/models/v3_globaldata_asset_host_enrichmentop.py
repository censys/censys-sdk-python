...
class V3GlobaldataAssetHostEnrichmentGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3GlobaldataAssetHostEnrichmentGlobals(BaseModel):
...
class V3GlobaldataAssetHostEnrichmentRequestTypedDict(TypedDict):
    host_ip: str
...
class V3GlobaldataAssetHostEnrichmentRequest(BaseModel):
    host_ip: Annotated[
...
class V3GlobaldataAssetHostEnrichmentResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ResponseEnvelopeHostEnrichmentAssetTypedDict


class V3GlobaldataAssetHostEnrichmentResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ResponseEnvelopeHostEnrichmentAsset
