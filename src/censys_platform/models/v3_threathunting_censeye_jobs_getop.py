...
class V3ThreathuntingCenseyeJobsGetGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3ThreathuntingCenseyeJobsGetGlobals(BaseModel):
...
class V3ThreathuntingCenseyeJobsGetRequestTypedDict(TypedDict):
    job_id: str
...
class V3ThreathuntingCenseyeJobsGetRequest(BaseModel):
    job_id: Annotated[
...
class V3ThreathuntingCenseyeJobsGetResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ResponseEnvelopeCenseyeJobTypedDict


class V3ThreathuntingCenseyeJobsGetResponse(BaseModel):
    headers: Dict[str, List[str]]
