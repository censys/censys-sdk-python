...
class DicomAssociateAcTypedDict(TypedDict):
    implementation_class_uid: NotRequired[str]
    implementation_version_name: NotRequired[str]


class DicomAssociateAc(BaseModel):
