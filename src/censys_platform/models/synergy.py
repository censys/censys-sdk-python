...
class SynergyTypedDict(TypedDict):
    protocol_major: NotRequired[int]
    protocol_minor: NotRequired[int]
...
class Synergy(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["protocol_major", "protocol_minor", "protocol_version"])
