...
class V3TagsDeleteTagGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3TagsDeleteTagGlobals(BaseModel):
...
class V3TagsDeleteTagRequestTypedDict(TypedDict):
    tag_id: str
...
class V3TagsDeleteTagRequest(BaseModel):
    tag_id: Annotated[
...
class V3TagsDeleteTagResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]


class V3TagsDeleteTagResponse(BaseModel):
    headers: Dict[str, List[str]]
