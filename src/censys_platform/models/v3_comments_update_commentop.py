...
class V3CommentsUpdateCommentGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3CommentsUpdateCommentGlobals(BaseModel):
...
class V3CommentsUpdateCommentRequestTypedDict(TypedDict):
    comment_id: str
    r"""The ID of the comment to update."""
    update_comment_input_body: UpdateCommentInputBodyTypedDict
    organization_id: NotRequired[str]
...
class V3CommentsUpdateCommentRequest(BaseModel):
    comment_id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]
    r"""The ID of the comment to update."""

    update_comment_input_body: Annotated[
        UpdateCommentInputBody,
...
class V3CommentsUpdateCommentResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ResponseEnvelopeCommentTypedDict


class V3CommentsUpdateCommentResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ResponseEnvelopeComment
