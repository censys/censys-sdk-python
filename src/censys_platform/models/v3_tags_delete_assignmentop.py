...
class V3TagsDeleteAssignmentGlobalsTypedDict(TypedDict):
    organization_id: NotRequired[str]


class V3TagsDeleteAssignmentGlobals(BaseModel):
...
class V3TagsDeleteAssignmentRequestTypedDict(TypedDict):
    tag_id: str
    r"""The ID of the tag."""
    assignment_id: str
    r"""The ID of the assignment to delete."""
    organization_id: NotRequired[str]
...
class V3TagsDeleteAssignmentRequest(BaseModel):
    tag_id: Annotated[
...
class V3TagsDeleteAssignmentResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]


class V3TagsDeleteAssignmentResponse(BaseModel):
    headers: Dict[str, List[str]]
