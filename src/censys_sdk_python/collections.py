...
class Collections(BaseSDK):
    ...
    def list(
        ...
        *,
        request: Union[
            models.V3CollectionsCrudListRequest,
            models.V3CollectionsCrudListRequestTypedDict,
        ] = models.V3CollectionsCrudListRequest(),
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.V3CollectionsCrudListRequest)
        request = cast(models.V3CollectionsCrudListRequest, request)
    ...
    def create(
        ...
        *,
        request: Union[
            models.V3CollectionsCrudCreateRequest,
            models.V3CollectionsCrudCreateRequestTypedDict,
        ] = models.V3CollectionsCrudCreateRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.V3CollectionsCrudCreateRequest)
        request = cast(models.V3CollectionsCrudCreateRequest, request)
    ...
    def delete(
        ...
        *,
        request: Union[
            models.V3CollectionsCrudDeleteRequest,
            models.V3CollectionsCrudDeleteRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.V3CollectionsCrudDeleteRequest)
        request = cast(models.V3CollectionsCrudDeleteRequest, request)
    ...
    def get(
        ...
        *,
        request: Union[
            models.V3CollectionsCrudGetRequest,
            models.V3CollectionsCrudGetRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.V3CollectionsCrudGetRequest)
        request = cast(models.V3CollectionsCrudGetRequest, request)
    ...
    def update(
        ...
        *,
        request: Union[
            models.V3CollectionsCrudUpdateRequest,
            models.V3CollectionsCrudUpdateRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.V3CollectionsCrudUpdateRequest)
        request = cast(models.V3CollectionsCrudUpdateRequest, request)
    ...
    def aggregate(
        ...
        *,
        request: Union[
            models.V3CollectionsSearchAggregateRequest,
            models.V3CollectionsSearchAggregateRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = cast(models.V3CollectionsSearchAggregateRequest, request)
    ...
    def search(
        ...
        *,
        request: Union[
            models.V3CollectionsSearchQueryRequest,
            models.V3CollectionsSearchQueryRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.V3CollectionsSearchQueryRequest)
        request = cast(models.V3CollectionsSearchQueryRequest, request)
